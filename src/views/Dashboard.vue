    ...
    <div class="row py-4">
      <div class="col-md-4 col-sm-12 py-2">
        <div class="dashboard__card">
          <div class="wrapper bg-dark">
            <div class="header">
              <div class="date">
                <i class="fas fa-crown dashboard__card-icon"></i>
              </div>
            </div>
            <div class="data">
              <div class="content">
                ...
                <p class="text">
                  Invite friends to join a new game
                </p>
      ...
      <div class="col-md-4 col-sm-12 py-2">
        <app-dash-card
          icon="fas fa-trophy"
          title="Achievements"
          description="Skills, Stats, Streaks and Sweet Sweet Victories"
          btn="Coming Soon!"
        ></app-dash-card>
      </div>
    </div>
...
<script>
import AppDashCard from "../components/ui/Card.vue";
